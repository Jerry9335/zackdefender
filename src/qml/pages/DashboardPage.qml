                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: mainWindow.scanner.progress + "% — "
                                + (mainWindow.scanner.currentFile || "扫描中...")
                ...
                Card {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                width: 48; height: 48; radius: 24
                                color: history.threatCount > 0 ? "#F44336" : "#4CAF50"
                                Text {
                                    anchors.centerIn: parent
                                    text: history.threatCount > 0 ? "⚠" : "✓"
                                    font.pixelSize: 24
                                }
                            }
                            ColumnLayout {
            ...
            RowLayout {
                ...
                Card {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: mainWindow.scanner.lastScanType || "尚未扫描"
                            font.pixelSize: 18; font.bold: true
                            color: Theme.color.onSurfaceColor
                        }
                        Text {
                            visible: mainWindow.scanner.lastScanTime !== ""
                            text: mainWindow.scanner.lastScanTime
                            font.pixelSize: 12; color: Theme.color.onSurfaceVariantColor
                        }
                    }
                }
            ...
            Card {
                ...
                ColumnLayout {
                    ...
                    GridLayout {
                        ...
                        Text { text: "Windows Defender"; color: Theme.color.onSurfaceColor; font.pixelSize: 14 }
